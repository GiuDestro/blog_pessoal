...
public class Postagem {
	...
	@NotBlank(message="O atributo TÍTULO é obrigatório!") // validation - validar o atributo NN e not empty
	@Size(min = 5, max = 100, message="O atributo TÍTULO deve ter no mínimo 5 caracteres e no máximo 100 carcteres.")
