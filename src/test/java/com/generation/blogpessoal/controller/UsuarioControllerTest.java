...
public class UsuarioControllerTest {
	...
	public void deveCriarUmNovoUsuario() {
		...
		(new Usuario (0L, "Giulia", "giulia@email.com", "12345678", ""));
	...
	public void naoDeveDuplicarUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario 
				(0L, "Maria da Silva", "maria_silva@email.com", "123456789", ""));
	...
	public void deveAtualizarUmUsuario() {
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new Usuario
				(0L, "Juliana Matias", "jumatiias@email.com", "juliana123", ""));
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), 
				"Juliana Ramos", "juramos@email.com", "juliana123","");
	...
	public void deveMostarTodosUsuarios( ) {
		usuarioService.cadastrarUsuario(new Usuario (0L, "Paulo Rocha", "paulorocha@email.com", "paulorocha123", ""));
		usuarioService.cadastrarUsuario(new Usuario (0L, "Samantha Freire", "samfreire@email.com", "samfreire123", ""));
